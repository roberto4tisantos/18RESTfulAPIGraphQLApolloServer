...
const SignupForm = ({ handleModalClose }: { handleModalClose: () => void }) => {
  ...
  const handleFormSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Send the mutation to create a new user
      const { data } = await addUser({
        variables: { ...userFormData }, // Pass form data as mutation variables
      });

      // On success, get the token and login the user
      ...
      console.error(err);
      setShowAlert(true); // Show an error alert if something goes wrong
    }
  ...
  return (
    <>
      ...
      <Form noValidate onSubmit={handleFormSubmit}>
        {/* Show alert if there's an error during the signup process */}
